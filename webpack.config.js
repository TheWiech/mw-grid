...
const entryPoints = ["polyfills", "sw-register", "vendor", "main"];
const baseHref = "";
const deployUrl = "";
...
const postcssPlugins = function () {
    ...
    ].concat(production ? [cssnano(minimizeOptions)] : []);
};

module.exports = function (env) {
    production = env.production;
    const deployHref = production === true ? 'mw-grid' : '';
    return {
        resolve: {
            extensions: [
                ".ts",
        ...
        plugins: [
            ...
            new BaseHrefWebpackPlugin({ baseHref: `/${ deployHref }` }),
            ...
            new CommonsChunkPlugin({
                ...
                minChunks: (module) => {
                        if ((/bootstrap\.min\.css$/).test(module.resource)) {
                            return false;
                        }
